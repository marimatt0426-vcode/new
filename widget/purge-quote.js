...
(function () {
  ...
  var PQ_CONFIG = {
    ...
    copy: {
      ...
      detailsTitle: "Last step — lock it in",
      detailsBody: "Tell us who you are and where the yard is.",
      ...
      ctaStandard: "Book My First Visit",
      ctaCustom: "Request My Estimate",
      doneTitle: "You’re in! 🎉",
      doneBody: "Watch your texts — we’ll confirm your first visit shortly. You’ll get a heads-up message before every visit and a gate photo when we wrap up.",
      doneOneTimeExtra: "We’ll also reach out about your base-rate deposit to get you on the schedule.",
    ...
    try {
      localStorage.setItem(STORE_KEY, JSON.stringify({
        ...
        s: {
          ...
          notes: state.notes, contact: state.contact
        }
      }));
    } catch (e) {}
  }
